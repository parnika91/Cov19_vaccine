...
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[1], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[2], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[3], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[4], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[5], font.size = 4)

netAnalysis_contribution(Ctrl.7, signaling = pathways.show[6], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[7], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[8], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[9], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[10], font.size = 4)

netAnalysis_contribution(Ctrl.7, signaling = pathways.show[11], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[12], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[13], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[14], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[15], font.size = 4)

netAnalysis_contribution(Ctrl.7, signaling = pathways.show[16], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[17], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[18], font.size = 4)
netAnalysis_contribution(Ctrl.7, signaling = pathways.show[19], font.size = 4)
```

```{r pathway_net_agg, fig.dim = c(10,8)}
par(mfrow=c(3,2))
...
```{r LR_plots, fig.dim=c(10,8)}
par(mfrow=c(4,5), xpd = T)
for(j in 1:nrow(pairLR$pairLR))
  netVisual_individual(Ctrl.7, signaling = "MHC-I",  pairLR.use = pairLR$pairLR[j], layout = "hierarchy")
```
